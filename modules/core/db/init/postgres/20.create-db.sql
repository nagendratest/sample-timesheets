...
alter table TS_PROJECT add constraint FK_TS_PROJECT_CLIENT foreign key (CLIENT_ID) references TS_CLIENT(ID)^
...
alter table TS_TASK add constraint FK_TS_TASK_TYPE foreign key (TYPE_ID) references TS_TASK_TYPE(ID)^
...
alter table TS_TIME_ENTRY add constraint FK_TS_TIME_ENTRY_USER foreign key (USER_ID) references SEC_USER(ID)^
alter table TS_TIME_ENTRY add constraint FK_TS_TIME_ENTRY_ACTIVITY_TYPE foreign key (ACTIVITY_TYPE_ID) references TS_ACTIVITY_TYPE(ID)^
...
alter table TS_PROJECT_PARTICIPANT add constraint FK_TS_PROJECT_PARTICIPANT_PROJECT foreign key (PROJECT_ID) references TS_PROJECT(ID)^
alter table TS_PROJECT_PARTICIPANT add constraint FK_TS_PROJECT_PARTICIPANT_ROLE foreign key (ROLE_ID) references TS_PROJECT_ROLE(ID)^
